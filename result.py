...
class resultclass:
    def __init__(self,root):
        ...
        #===title======================
        title=Label(self.root,text="ADD STUDENT RESULT", font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=50)
        #======widgets=================
        #======variables===============
        ...
        lbl_coures=Label(self.root,text="Courses",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=220)
        ...
        #=====button====
        btn_add=Button(self.root,text="SUBMIT",font=("goudy old style",15),bg="lightblue",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear=Button(self.root,text="CLEAR",font=("goudy old style",15),bg="lightblue",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)

        #======image=======
        self.bg_img=Image.open("images/results.jpg")
